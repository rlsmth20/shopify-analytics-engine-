...
export const metadata = {
  title: "skubase â€” The Shopify inventory tool that tells you what to do first",
  description:
...
const migrationCards = [
  ...
  { eyebrow: "Forecasting in a spreadsheet?", date: "ShipStation export â†’ Google Sheet â†’ trailing average", title: "Better than your spreadsheet.", body: "If your reorder math is a 6-month moving average in a Google Sheet, you''re tying up cash you don''t need to and missing every seasonal ramp. skubase fixes both â€” drop in your ShipStation export and see real velocity in minutes.", cta: "See why", href: "/vs-spreadsheet", tone: "steady" },
  { eyebrow: "Leaving Genie?", date: "Genie closed Aug 31, 2025", title: "Genie is gone. skubase is the upgrade.", body: "Genie merchants loved simple. We kept the simple and added the math â€” forecasting, supplier metrics, and a real reorder engine.", cta: "See the migration path", href: "/goodbye-genie", tone: "steady" }
];
...
const positioning = [
  ...
  { title: "Math you can see.", body: "Every recommended quantity explains itself â€” trailing demand, seasonality factor, service level, stockout probability. Explainability is a feature." },
    ...
    <div className="marketing-shell">
      ...
      <section className="marketing-hero">
        ...
        <p className="marketing-hero-sub">
          Forecast the next 90 days, rank every SKU, score every supplier, and recover cash from dead stock â€” in one Shopify-first product, at a price that doesn&apos;t triple at renewal.
        </p>
      ...
      <section className="marketing-migration" aria-label="Migration windows">
        {migrationCards.map((card) => (
          <article key={card.href} className={`migration-card migration-card-${card.tone}`}>
            ...
            <Link href={card.href} className="migration-card-cta">{card.cta} â†’</Link>
          </article>
        ))}
      </section>
      ...
      <section className="marketing-section" id="pillars">
        ...
        <p className="marketing-section-sub">
          We studied twenty-five inventory products. These are the six gaps that appeared over and over â€” and every one of them ships in skubase today.
        </p>
        <div className="pillar-grid">
          {pillars.map((p) => (
            <article key={p.href} className="pillar-card">
              ...
              <Link href={p.href} className="pillar-card-link">See in demo â†’</Link>
            </article>
          ))}
        </div>
      </section>
      ...
      <section className="marketing-section marketing-section-alt">
        ...
        <h2 className="marketing-section-title">Why the rest of the market is the way it is â€” and why skubase isn&apos;t.</h2>
      ...
      <footer className="marketing-footer">
        ...
        <p className="marketing-footer-fine">
          Â© {new Date().getFullYear()} skubase Â· Independent Â· Founder-led Â· Prices locked at renewal
        </p>
      </footer>
    </div>
  );
