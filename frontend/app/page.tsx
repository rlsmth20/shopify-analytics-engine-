...
const pillars = [
  ...
  },
  {
    ...
    body: "On-time delivery, fill rate, lead-time stability, and preferred / acceptable / at-risk tiering. 23 of the 25 tools we studied still treat vendors as contact records.",
  ...
  },
  {
    ...
    body: "Kits decompose at reorder time, so you never place a PO that leaves a component short. Bundle bottlenecks are called out on the dashboard.",
    href: "/bundles?demo=1",
  },
  {
    kicker: "Dashboard",
...
const migrationCards = [
  {
    ...
    title: "Goodbye Stocky, hello skubase.",
    body: "Shopify sunset a tool thousands of POS Pro merchants depended on. We built the replacement you actually wanted: forecasting, supplier scorecards, and dead-stock plans in one product.",
...
const positioning = [
  {
    ...
    body: "Eight of the tools you evaluate have been acquired by a parent that raised prices, slowed the roadmap, or broke support. skubase is structurally outside that pattern.",
  },
  {
    title: "Shopify-first today. Multi-channel coming.",
    body: "Our deepest integration is Shopify. ShipStation imports already cover Amazon, eBay, and Walmart shipment history. Native Amazon and eBay writes are on the roadmap; until then, we replace the forecasting layer alongside whatever channel-sync tool you use.",
  },
  {
  ...
  },
  {
    ...
    body: "We publish our tiers. We commit in writing that renewals do not raise the price on your plan. We mean it.",
  },
];
    ...
    <div className="marketing-shell">
      ...
      <section className="marketing-section" id="pillars">
        ...
        <div className="pillar-grid">
          {pillars.map((pillar) => (
            <article key={pillar.href} className="pillar-card">
      ...
      <section className="marketing-section marketing-section-alt">
        ...
        <div className="positioning-grid">
          {positioning.map((item) => (
            <article key={item.title} className="positioning-card">
              <h3 className="positioning-card-title">{item.title}</h3>
              <p className="positioning-card-body">{item.body}</p>
            </article>
          ))}
        </div>
      </section>
