...
const pillars = [
  ...
  {
    kicker: "Bundle Opportunities",
    title: "Find products customers buy together.",
    body: "Skubase surfaces bundle, kit, and cross-sell opportunities from order history. Component-level bundle inventory checks require bundle mappings.",
    href: "/bundles?demo=1",
  },
  {
    kicker: "Today",
