...
export const metadata = {
  ...
  description: "If your forecasting lives in a Google Sheet with a trailing 6-month average, you're tying up cash you don't need to. slelfly fixes that in ten minutes.",
...
const reasons = [
  ...
  { title: "Trailing averages miss seasonality and trend.", body: "A 6-month moving average is half-blind on every Q4 ramp. slelfly fits a Holt double-exponential model with a weekly seasonality factor, so a back-to-school SKU isn't reordered like a steady-state one." },
  { title: "All SKUs are not equal.", body: "Your A-items deserve a 99% service level; your C-items don't. slelfly segments by ABC × XYZ and sets safety stock per class — the math the spreadsheet can't do without becoming a part-time job." },
  { title: "Your suppliers are unmeasured.", body: "If your spreadsheet doesn't track which vendors miss promised lead times, you're carrying their failures as your stockouts. slelfly scores every vendor on on-time, fill rate, and lead-time stability." },
  { title: "Dead stock is a cash recovery problem your sheet ignores.", body: "The Sheet shows you what you have. It does not propose a markdown plan, a bundle, a wholesale list, or a write-off. slelfly does — with the dollar impact attached." }
];

const compare = [
  { metric: "Forecasting model", sheet: "Trailing 6-month moving average", slelfly: "Holt double-exponential + weekly seasonality + stockout probability" },
  { metric: "Safety stock", sheet: "Same buffer for every SKU", slelfly: "Service-level segmented by ABC × XYZ class" },
  { metric: "Reorder trigger", sheet: "Cover < 6 months", slelfly: "Days-until-stockout < lead time + safety, ranked by $ impact" },
  { metric: "Supplier accuracy", sheet: "Not tracked", slelfly: "On-time %, fill rate, lead-time stability, tiered" },
  { metric: "Bundle/kit logic", sheet: "Manual decomposition", slelfly: "Auto-decomposes at reorder time" },
  { metric: "Dead stock action", sheet: "None", slelfly: "Markdown / bundle / wholesale / write-off plans" },
  { metric: "Time to update", sheet: "30–60 minutes per week", slelfly: "Zero — recomputes when shipments land" },
  { metric: "Auditability", sheet: "Whoever last touched it", slelfly: "Every recommended quantity explains itself" }
];
...
const steps = [
  ...
  { n: "3", title: "Get ranked actions", body: "Slelfly ranks every SKU into urgent reorders, overstock to draw down, and dead stock to liquidate. Work the queue; close the spreadsheet." }
];
    ...
    <div className="marketing-shell">
      ...
      <section className="marketing-hero marketing-hero-migration">
        ...
        <p className="marketing-hero-sub">
          If your forecasting lives in a Google Sheet — ShipStation export pasted in, six-month trailing average computed, reorder when cover drops below six months — you&apos;re carrying more inventory than you need to and you&apos;re still missing seasonality. slelfly fixes both, in under ten minutes.
        </p>
      ...
      <section className="marketing-section">
        ...
        <h2 className="marketing-section-title">Five things your sheet can&apos;t do — and slelfly does by default.</h2>
      ...
      <section className="marketing-section marketing-section-alt">
        ...
        <div className="compare-table-wrapper">
          <table className="compare-table">
            <thead>
              <tr><th>Metric</th><th>Your spreadsheet</th><th>slelfly</th></tr>
            </thead>
            <tbody>
              {compare.map((row) => (
                <tr key={row.metric}>
