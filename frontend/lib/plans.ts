...
export const PLAN_CAPABILITIES: Record<CapabilityKey, PlanCapability> = {
  ...
  transfers: {
    ...
    description: "Review and export transfer recommendations when location-level inventory is available. The current Shopify sync imports aggregate stock only; it does not populate location-level recommendations or execute transfers.",
    cta: "Upgrade to Scale",
  },
  scheduled_reports: {
    requiredPlan: "scale",
    title: "Scheduled Reports",
    description: "Email any report automatically - weekly on Monday morning or monthly on the 1st.",
    cta: "Upgrade to Scale",
  },
  team_controls: {
    requiredPlan: "scale",
    title: "Team administration (planned)",
    description: "Self-service team invitations and role management are planned. Contact support for current workspace changes.",
    cta: "Upgrade to Scale",
  },
  priority_support: {
    requiredPlan: "scale",
    title: "Priority Support",
    description: "Get help with onboarding and inventory planning for higher-volume operations.",
    cta: "Upgrade to Scale",
  },
};
...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    features: [
      ...
      { label: "Monday Buy List weekly email", included: true },
      { label: "14-day free trial", included: true },
      { label: "Forecasting, Reorder / POs, and full Excel exports", included: false },
      { label: "Bundle Opportunities and transfer planning", included: false },
    ],
    monthly: { plan: "starter_monthly", price: "$29" },
    annual: { plan: "starter_annual", price: "$24.67", yearTotal: "$296" },
  },
  {
    key: "growth",
    name: "Growth",
    pitch: "For Shopify brands ready to turn forecasts into purchase plans and exportable reports.",
    ...
    features: [
      ...
      { label: "Reorder / PO planning with open-to-buy cash plan", included: true },
      { label: "Projected Stock Health", included: true },
      { label: "Bundle Opportunities and dead-stock bundle pairings", included: true },
      { label: "Full Reports & Exports (styled Excel workbooks)", included: true },
    ...
    annual: { plan: "growth_annual", price: "$84.17", yearTotal: "$1,010" },
  },
  {
    key: "scale",
    name: "Scale",
    pitch: "For larger catalogs that need scheduled reporting, supplier scorecards, and onboarding support.",
    limit: "Up to 25,000 active SKUs - 10 locations - unlimited seats",
    featured: false,
    features: [
      { label: "Everything in Growth", included: true },
      { label: "Scheduled email reports (weekly Monday or monthly delivery)", included: true },
      { label: "Transfer-planning workspace (requires location data; current Shopify sync imports aggregate stock only)", included: true },
      { label: "Supplier scorecards when PO receipt history exists", included: true },
      { label: "Higher-volume catalog support", included: true },
      { label: "Self-service team roles (planned)", included: false },
      { label: "Priority support", included: true },
      { label: "Onboarding assistance", included: true },
      { label: "14-day free trial", included: true },
    ],
    monthly: { plan: "scale_monthly", price: "$199" },
    annual: { plan: "scale_annual", price: "$169.17", yearTotal: "$2,030" },
  },
];
