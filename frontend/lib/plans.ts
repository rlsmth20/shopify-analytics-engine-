...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    key: "scale",
    name: "Scale",
    pitch: "For multi-store operators that want concierge setup and stronger admin controls.",
    limit: "Up to 25,000 active SKUs - 10 locations - unlimited seats",
    featured: false,
    features: [
      { label: "Everything in Growth", included: true },
      { label: "PO approval + send status flow", included: true },
      { label: "Decision snapshots and audit history", included: true },
      { label: "Admin/member workspace roles", included: true },
      { label: "Priority support (same-business-day response)", included: true },
      { label: "Onboarding concierge", included: true },
      { label: "Enterprise access controls through admin roles", included: true },
    ],
