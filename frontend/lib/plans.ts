...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Approval-ready reorder planning and PO drafts", included: true },
      { label: "SMS + webhook alerts", included: true },
      { label: "Scheduled reports, planned", included: true },
      { label: "Team roles, audit logs, SSO", included: false },
    ],
  ...
  },
  {
    key: "scale",
    name: "Scale",
    pitch: "For multi-store operators that want concierge setup and planned admin controls.",
    limit: "Up to 25,000 active SKUs - 10 locations - unlimited seats",
    featured: false,
    features: [
      { label: "Everything in Growth", included: true },
      { label: "Advanced PO approval + send flow, planned", included: true },
      { label: "Decision snapshots and audit history, planned", included: true },
      { label: "Workspace roles, planned", included: true },
      { label: "Priority support (same-business-day response)", included: true },
      { label: "Onboarding concierge", included: true },
      { label: "Enterprise access controls, planned", included: true },
    ],
