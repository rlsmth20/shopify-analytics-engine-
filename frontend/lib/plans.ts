...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    featured: false,
    features: [
      { label: "Action Queue for urgent inventory issues", included: true },
      { label: "Stockout risk and dead-stock alert rules", included: true },
      ...
      { label: "Reorder recommendations and PO drafts", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Advanced alert routing through enabled SMS, Slack, email, and webhook channels", included: true },
