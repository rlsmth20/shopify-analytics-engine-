...
export const FEATURE_CATALOG: CatalogGroup[] = [
  {
    ...
    features: [
      ...
      },
      {
        name: "Action Queue",
        description:
          "Every SKU ranked urgent / optimize / dead with a recommended action and the dollar impact of doing it — or ignoring it.",
        detail: "Starter includes the core queue; Growth adds full ranking depth and richer action context.",
      ...
      },
      {
        name: "Alerts & Rules",
        description:
          "Rules for stockout risk, reorder deadlines, overstock, dead stock, forecast risk, and supplier slip — evaluated automatically and delivered where you work.",
        detail: "Email + Slack channels on every plan. Webhook channels on Growth and Scale. SMS is planned.",
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        detail: "Starter includes default lead time and coverage; Growth adds per-vendor and per-category overrides.",
