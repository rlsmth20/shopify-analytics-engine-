  ...
  opportunities: [
    {
      id: "demo-hoodie-cap",
      product_a_id: 101,
      product_a_name: "Essential Hoodie - Black / M",
      product_a_sku: "sku_essential-hoodie-black-m",
      product_a_category: "Outerwear",
      product_b_id: 102,
      product_b_name: "Everyday Cap - Forest",
      product_b_sku: "sku_everyday-cap-forest",
      product_b_category: "Accessories",
      co_purchase_count: 74,
      support: 0.0402,
      confidence_a_to_b: 0.31,
      confidence_b_to_a: 0.24,
      lift: 1.8,
      combined_revenue: 10642,
      average_order_value_impact: 143.81,
      opportunity_type: "Bundle",
      suggested_action: "Create bundle",
      explanation:
        "Customers who buy Essential Hoodie - Black / M also bought Everyday Cap - Forest in 74 orders. Confidence: 31% of hoodie orders also contained the cap.",
    },
    {
      id: "demo-leggings-tee",
      product_a_id: 103,
      product_a_name: "Core Leggings - Charcoal / S",
      product_a_sku: "sku_core-leggings-charcoal-s",
      product_a_category: "Activewear",
      product_b_id: 104,
      product_b_name: "Performance Tee - Navy / L",
      product_b_sku: "sku_performance-tee-navy-l",
      product_b_category: "Tops",
      co_purchase_count: 61,
      support: 0.0332,
      confidence_a_to_b: 0.28,
      confidence_b_to_a: 0.21,
      lift: 1.6,
      combined_revenue: 8784,
      average_order_value_impact: 144,
      opportunity_type: "Bundle",
      suggested_action: "Create bundle",
      explanation:
        "Core Leggings and Performance Tee appeared together in 61 orders, a strong activewear kit candidate.",
    },
    {
      id: "demo-slides-shorts",
      product_a_id: 105,
      product_a_name: "Recovery Slides - Sand / 9",
      product_a_sku: "sku_recovery-slides-sand-9",
      product_a_category: "Footwear",
      product_b_id: 106,
      product_b_name: "Training Shorts - Navy / M",
      product_b_sku: "sku_training-shorts-navy-m",
      product_b_category: "Activewear",
      co_purchase_count: 38,
      support: 0.0207,
      confidence_a_to_b: 0.22,
      confidence_b_to_a: 0.18,
      lift: 1.4,
      combined_revenue: 4826,
      average_order_value_impact: 127,
      opportunity_type: "Cross-sell",
      suggested_action: "Add cross-sell",
      explanation:
        "Recovery Slides show a repeat cross-sell pattern with Training Shorts. Test a post-workout add-on offer.",
    },
    {
      id: "demo-bottle-towel",
      product_a_id: 107,
      product_a_name: "Hydration Bottle - Smoke",
      product_a_sku: "sku_hydration-bottle-smoke",
      product_a_category: "Accessories",
      product_b_id: 108,
      product_b_name: "Gym Towel - Slate",
      product_b_sku: "sku_gym-towel-slate",
      product_b_category: "Accessories",
      co_purchase_count: 33,
      support: 0.0179,
      confidence_a_to_b: 0.19,
      confidence_b_to_a: 0.26,
      lift: 1.7,
      combined_revenue: 2178,
      average_order_value_impact: 66,
      opportunity_type: "Promo test",
      suggested_action: "Test promo",
      explanation:
        "Hydration Bottle and Gym Towel have enough co-purchase signal for a small promo test without creating a permanent bundle.",
    },
    {
      id: "demo-tote-cap",
      product_a_id: 109,
      product_a_name: "Weekend Tote - Natural",
      product_a_sku: "sku_weekend-tote-natural",
      product_a_category: "Accessories",
      product_b_id: 102,
      product_b_name: "Everyday Cap - Forest",
      product_b_sku: "sku_everyday-cap-forest",
      product_b_category: "Accessories",
      co_purchase_count: 21,
      support: 0.0114,
      confidence_a_to_b: 0.16,
      confidence_b_to_a: 0.09,
      lift: 1.2,
      combined_revenue: 2142,
      average_order_value_impact: 102,
      opportunity_type: "Watch",
      suggested_action: "Watch",
      explanation:
        "Weekend Tote and Everyday Cap appear together often enough to monitor, but the confidence is lower than stronger bundle candidates.",
    },
  ],
  bundles: [
    {
...
export const DEMO_TRANSFERS = {
  transfers: [
    {
      sku_id: "sku_essential-hoodie-black-m",
      name: "Essential Hoodie - Black / M",
      from_location: "Main Warehouse",
      to_location: "Retail Store",
      qty: 24,
      source_stock: 144,
      destination_stock: 18,
      destination_days_left: 6,
      lead_time_days: 14,
      priority: "Critical" as const,
      status: "Recommended" as const,
      from_days_of_cover_before: 120,
      to_days_of_cover_before: 6,
      from_days_of_cover_after: 100,
      to_days_of_cover_after: 14,
      rationale:
        "Move 24 units from Main Warehouse to Retail Store because Retail Store has 6 days left and Main Warehouse has 120 days of cover.",
    },
    {
      sku_id: "sku_core-leggings-charcoal-s",
      name: "Core Leggings - Charcoal / S",
      from_location: "3PL West",
      to_location: "3PL East",
      qty: 36,
      source_stock: 162,
      destination_stock: 22,
      destination_days_left: 9,
      lead_time_days: 12,
      priority: "High" as const,
      status: "Recommended" as const,
      from_days_of_cover_before: 88,
      to_days_of_cover_before: 9,
      from_days_of_cover_after: 68,
      to_days_of_cover_after: 24,
      rationale:
        "3PL East is inside lead time while 3PL West has excess cover. Transfer before opening a new PO.",
    },
    {
      sku_id: "sku_performance-tee-navy-l",
      name: "Performance Tee - Navy / L",
      from_location: "Main Warehouse",
      to_location: "3PL East",
      qty: 48,
      source_stock: 210,
      destination_stock: 41,
      destination_days_left: 13,
      lead_time_days: 10,
      priority: "Medium" as const,
      status: "Recommended" as const,
      from_days_of_cover_before: 76,
      to_days_of_cover_before: 13,
      from_days_of_cover_after: 59,
      to_days_of_cover_after: 28,
      rationale:
        "3PL East is approaching the reorder window and Main Warehouse has enough excess to rebalance without creating a freight-heavy vendor order.",
    },
    {
      sku_id: "sku_everyday-cap-forest",
      name: "Everyday Cap - Forest",
      from_location: "Retail Store",
      to_location: "3PL West",
      qty: 18,
      source_stock: 96,
      destination_stock: 16,
      destination_days_left: 11,
      lead_time_days: 7,
      priority: "Medium" as const,
      status: "Recommended" as const,
      from_days_of_cover_before: 104,
      to_days_of_cover_before: 11,
      from_days_of_cover_after: 84,
      to_days_of_cover_after: 23,
      rationale:
        "Retail Store has excess cap inventory while 3PL West is nearing its local reorder point.",
    },
    {
      sku_id: "sku_recovery-slides-sand-9",
      name: "Recovery Slides - Sand / 9",
      from_location: "3PL East",
      to_location: "Retail Store",
      qty: 30,
      source_stock: 138,
      destination_stock: 20,
      destination_days_left: 7,
      lead_time_days: 14,
      priority: "Critical" as const,
      status: "Recommended" as const,
      from_days_of_cover_before: 92,
      to_days_of_cover_before: 7,
      from_days_of_cover_after: 72,
      to_days_of_cover_after: 18,
      rationale:
        "Retail Store demand is outrunning local stock. 3PL East can spare 30 units and keep healthy cover after the move.",
    },
  ],
};
...
export const DEMO_BUYING_CALENDAR = {
  generated_at: new Date().toISOString(),
  horizon_days: 180,
  total_estimated_cost: 31280,
  due_now_count: 2,
  future_count: 4,
  saved_open_count: 1,
  events: [
    {
      event_id: "CAL-DEMO-COASTAL-NOW",
      vendor: "Coastal Apparel Co.",
      source: "recommended" as const,
      status: "planned",
      order_by_date: daysFromNow(0),
      expected_arrival_date: daysFromNow(16),
      days_until_order: 0,
      lead_time_days: 14,
      line_count: 2,
      ...
      rationale:
        "Projected to cross reorder point this week. Plan one consolidated Coastal Apparel buy before lead time consumes the buffer.",
      lines: [
        {
          sku_id: "sku_premium-linen-shirt-navy-m",
          name: "Premium Linen Shirt - Navy M",
    ...
    {
      event_id: "CAL-DEMO-NORTHTHREAD-NOW",
      vendor: "NorthThread Supply",
      source: "recommended" as const,
      status: "planned",
      order_by_date: daysFromNow(4),
      expected_arrival_date: daysFromNow(24),
      days_until_order: 4,
      lead_time_days: 18,
      line_count: 1,
      total_units: 200,
      ...
      rationale:
        "Winter demand is rising. Schedule this buy this week so arrival lands before the ramp.",
      lines: [
        {
          sku_id: "sku_wool-blend-sweater-grey-l",
          name: "Wool Blend Sweater - Grey L",
    ...
    {
      event_id: "SAVED-DEMO-EAST",
      vendor: "Eastbank Basics",
      source: "saved" as const,
      status: "sent",
      order_by_date: daysFromNow(-3),
      expected_arrival_date: daysFromNow(18),
      days_until_order: -3,
      lead_time_days: 21,
      line_count: 1,
      total_units: 160,
      ...
      rationale:
        "Saved PO already sent; keep it visible until the remaining units are received.",
      lines: [
        {
          sku_id: "sku_core-tee-white-m",
          name: "Core Tee - White M",
          qty: 160,
          unit_cost: 32,
          extended_cost: 5120,
    ...
    {
      event_id: "CAL-DEMO-PACIFIC-37",
      vendor: "Pacific Goods Ltd.",
      source: "recommended" as const,
      status: "planned",
      order_by_date: daysFromNow(37),
      expected_arrival_date: daysFromNow(58),
      days_until_order: 37,
      lead_time_days: 21,
      line_count: 2,
      total_units: 240,
      ...
      rationale:
        "Projected to enter the reorder window next month. Keep this as a planned Pacific Goods buy instead of waiting for an urgent queue item.",
      lines: [
        {
          sku_id: "sku_slim-fit-chinos-khaki-32x30",
          name: "Slim Fit Chinos - Khaki 32x30",
          qty: 150,
          unit_cost: 22,
          extended_cost: 3300,
          current_on_hand: 73,
    ...
    {
      event_id: "CAL-DEMO-COASTAL-72",
      vendor: "Coastal Apparel Co.",
      source: "recommended" as const,
      status: "planned",
      order_by_date: daysFromNow(72),
      expected_arrival_date: daysFromNow(86),
      days_until_order: 72,
      lead_time_days: 14,
      line_count: 1,
      total_units: 140,
      ...
      urgency: "future" as const,
      rationale:
        "A later Coastal Apparel replenishment window is projected after the current buy lands and sells through.",
      lines: [
        {
          sku_id: "sku_organic-cotton-hoodie-black-xl",
          name: "Organic Cotton Hoodie - Black XL",
    ...
    {
      event_id: "CAL-DEMO-ARTISAN-118",
      vendor: "Artisan Accessories",
      source: "recommended" as const,
      status: "planned",
      order_by_date: daysFromNow(118),
      expected_arrival_date: daysFromNow(130),
      days_until_order: 118,
      lead_time_days: 12,
      line_count: 1,
      total_units: 130,
      estimated_cost: 2635,
      urgency: "future" as const,
      rationale:
        "Canvas Tote Bag stays healthy for now, but should be on the late-season buying calendar.",
      lines: [
        {
          sku_id: "sku_canvas-tote-bag-natural",
          name: "Canvas Tote Bag - Natural",
  ...
  rules: [
    {
      ...
      target_skus: ["sku_premium-linen-shirt-navy-m", "sku_wool-blend-sweater-grey-l"],
      product_title_contains: "",
      categories: ["Apparel"],
      suppliers: ["Coastal Apparel Co.", "NorthThread Supply"],
      tags: ["bestseller"],
      collections: ["Spring launch"],
      locations: ["Retail Store"],
      enabled: true,
...
export const DEMO_ACTION_FEED = {
  ...
  actions: [
    // Urgent items
    {
      ...
      target_inventory_units: 270,
      reorder_point_units: 109,
      days_of_inventory: 8,
    ...
    },
    {
      ...
      target_inventory_units: 149,
      reorder_point_units: 56,
      days_of_inventory: 5,
      lead_time_days_used: 14,
      safety_buffer_days: 5,
      lead_time_source: "vendor" as const,
    ...
    },
    {
      ...
      target_inventory_units: 234,
      reorder_point_units: 88,
      days_of_inventory: 8,
    ...
    },
    {
      ...
      target_inventory_units: 246,
      reorder_point_units: 106,
    ...
    // Optimize items
    {
      ...
      daily_velocity: 4.9,
      safety_stock_units: 20,
      target_inventory_units: 147,
      reorder_point_units: 108,
    ...
    },
    {
      ...
      target_inventory_units: 86,
      reorder_point_units: 31,
    ...
    },
    {
      ...
      daily_velocity: 1.5,
      safety_stock_units: 8,
      target_inventory_units: 68,
      reorder_point_units: 29,
