param(
    [ValidateSet('review-export', 'review-import', 'outreach-status', 'outreach-reserve', 'outreach-complete', 'outreach-backfill', 'outreach-reconcile', 'operator-export', 'operator-enqueue', 'operator-claim', 'operator-complete', 'operator-state', 'operator-assess', 'operator-monitor', 'operator-monitor-start')][string]$Action = 'review-export',
    [string]$File,
    [string]$Model = 'codex'
)
...
try {
    ...
    if ($Action -in @('outreach-reserve', 'outreach-complete', 'outreach-reconcile', 'operator-enqueue', 'operator-claim', 'operator-complete', 'operator-assess', 'operator-monitor', 'operator-monitor-start')) {
