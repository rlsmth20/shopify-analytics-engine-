...
$growthAction = New-ScheduledTaskAction -Execute $growthPython -Argument ('-m app.growth.browser_executor --production --repo "' + $growthRepo + '"') -WorkingDirectory (Join-Path $growthRepo 'backend')
